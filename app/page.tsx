          ...
          <div className="mt-16 grid gap-12 md:grid-cols-3">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="relative mb-6 h-64 w-full overflow-hidden rounded-lg bg-gray-800">
                <Image
                  src="/images/platzhalter_startseite.png"
              ...
              <p className="mb-6 text-gray-300">
                Inspect every feature of every part in 30 seconds – even for the most complex parts such as EV battery
                trays and body-in-white.
              </p>
              <Button
                variant="outline"
