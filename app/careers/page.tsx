          ...
          <div className="mx-auto max-w-3xl bg-white rounded-lg shadow-md overflow-hidden">
            <div className="p-8 text-center">
              ...
              <Button
                size="lg"
                className="group"
                onClick={() => window.open("https://join.com/companies/iuna", "_blank")}
              >
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <span className="ml-3 text-gray-600">Access to the startup ecosystem through Campus Founders</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-gray-200 flex items-center justify-center mt-0.5">
                    <Check className="h-4 w-4 text-primary" />
